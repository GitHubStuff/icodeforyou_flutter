...
import 'package:sqlite_viewer/src/widgets/display_query_widget/display_query_widget.dart';
import 'package:sqlite_viewer/src/widgets/sql_command.dart' show SqlCommand;
import 'package:sqlite_viewer/src/widgets/sqlite_viewer_metadata_panel/sqlite_viewer_metadata_panel.dart';
import 'package:sqlite_viewer/src/widgets/sqlite_viewer_table_detail/sqlite_viewer_table_detail.dart';

part 'sqlite_viewer_page_helper_views.dart';
part 'sqlite_viewer_page_phone_layout.dart';
part 'sqlite_viewer_page_tablet_layout.dart';
...
@visibleForTesting
Widget buildDisconnectedViewForTesting() => const DisconnectedView();
...
@visibleForTesting
Widget buildEmptyDataViewForTesting() => const EmptyDataView();

/// Builds a select table prompt widget for testing.
@visibleForTesting
Widget buildSelectTablePromptForTesting() => const SelectTablePrompt();

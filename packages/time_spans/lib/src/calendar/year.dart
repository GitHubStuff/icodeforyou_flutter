...
///
/// This is the canonical home of the Gregorian leap rule: a year is a leap
/// year when it is divisible by 4, except for century years, which must also
/// be divisible by 400 (so 2000 is a leap year, 1900 is not). Pass the
/// resolved [isLeapYear] to month-length logic such as
/// [Month.daysInMonth] rather than re-deriving the rule elsewhere.
///

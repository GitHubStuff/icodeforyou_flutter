...
void main() {
  group('DateTimeExt', () {
    group('timeStamp', () {
      test(
        'should format timestamp with single digit hour, minute, second, millisecond',
        () {
          // Arrange
      ...
      test(
        'should format timestamp with double digit hour, minute, second',
        () {
          // Arrange
      ...
      test('should handle various hour ranges correctly', () {
        // Arrange & Act & Assert
        expect(DateTime(2023, 1, 1, 1).timeStamp(), equals('01:00:00.000'));
        expect(DateTime(2023, 1, 1, 12).timeStamp(), equals('12:00:00.000'));
        expect(DateTime(2023, 1, 1, 22).timeStamp(), equals('22:00:00.000'));
      });

      test('should handle various minute ranges correctly', () {
        // Arrange & Act & Assert
        expect(DateTime(2023, 1, 1, 12, 1).timeStamp(), equals('12:01:00.000'));
        expect(
          DateTime(2023, 1, 1, 12, 30).timeStamp(),
          equals('12:30:00.000'),
        );
        expect(
          DateTime(2023, 1, 1, 12, 59).timeStamp(),
          equals('12:59:00.000'),
        );
      });
      ...
      test('should handle various second ranges correctly', () {
        // Arrange & Act & Assert
        expect(
          DateTime(2023, 1, 1, 12, 30, 1).timeStamp(),
          equals('12:30:01.000'),
        );
        expect(
          DateTime(2023, 1, 1, 12, 30, 30).timeStamp(),
          equals('12:30:30.000'),
        );
        expect(
          DateTime(2023, 1, 1, 12, 30, 59).timeStamp(),
          equals('12:30:59.000'),
        );
      });
      ...
      test(
        'should handle microseconds correctly by using only millisecond portion',
        () {

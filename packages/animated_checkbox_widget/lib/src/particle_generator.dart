...
class ParticleGenerator {
  ...
  static const double _particleStep = 2.0;
  static const double _maxStaggerTime = 0.3;
  ...
  static List<DissolveParticle> generateFromPath(Path path) {
    ...
    for (final metric in metrics) {
      ...
      for (double distance = 0; distance < length; distance += _particleStep) {
  ...
  static Offset _generateRandomVelocity() {
    ...
    final speed = _random.nextDouble() * 20 + 10;

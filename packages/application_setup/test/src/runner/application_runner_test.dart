...
import 'package:shared_preferences_platform_interface/in_memory_shared_preferences_async.dart' show InMemorySharedPreferencesAsync;
  ...
  group('ApplicationRunner', () {
    ...
    test('run calls ensureInitialized and run on bootstrapper', () async {
      final runner = ApplicationRunner(
        splashBuilder: (_) => const SizedBox.shrink(),

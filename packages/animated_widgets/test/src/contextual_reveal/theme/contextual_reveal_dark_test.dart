// packages/animated_widgets/test/src/contextual_reveal/theme/contextual_reveal_dark_test.dart

import 'package:animated_widgets/src/contextual_reveal/src/theme/_contextual_reveal_defaults.dart';
import 'package:animated_widgets/src/contextual_reveal/src/theme/contextual_reveal_dark.dart';
import 'package:flutter/material.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  group('ContextualRevealDark', () {
    test('exposes the documented dark defaults', () {
      const theme = ContextualRevealDark();

      expect(theme.barrierColor, kDarkBarrierColor);
      expect(theme.popoverBackgroundShade, kDarkPopoverBackground);
    ...
    group('copyWith', () {
      test('falls back to every base value when given no arguments', () {
        final copy = const ContextualRevealDark().copyWith();

        expect(copy.barrierColor, kDarkBarrierColor);
        expect(copy.popoverBackgroundShade, kDarkPopoverBackground);
    ...
    group('lerp', () {
      ...
      final other = const ContextualRevealDark().copyWith(
      ...
      test('keeps its own values at t below 0.5', () {
        ...
        expect(result.barrierColor, kDarkBarrierColor);

// packages/animated_widgets/lib/src/stepper_cross_fade/stepper_cross_fade_view.dart
...
import 'stepper_crossfade_cubit.dart';

class StepperCrossfade extends StatelessWidget {
...
class _StepperCrossFadeState extends State<_StepperCrossFade> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => StepperCrossFadeCubit(
...
class _StepperCrossFadeBody extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final cubit = context.read<StepperCrossFadeCubit>();

    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        BlocBuilder<StepperCrossFadeCubit, int>(

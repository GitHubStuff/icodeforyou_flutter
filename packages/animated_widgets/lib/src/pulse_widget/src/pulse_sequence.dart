...
///
/// [PulseSequence] is layout-transparent: it occupies exactly the space its
...
/// animation identity is owned by [PulseSequence] itself and is independent
/// of [key]; callers may pass any key (or none) without affecting animation
/// behavior.
class PulseSequence extends StatefulWidget {
  const PulseSequence({
    required this.child,
    super.key,
  ...
  @override
  State<PulseSequence> createState() => _PulseSequenceState();
}

class _PulseSequenceState extends State<PulseSequence> {

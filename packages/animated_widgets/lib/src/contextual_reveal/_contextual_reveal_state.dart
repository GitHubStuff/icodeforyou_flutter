// animated_widgets/lib/src/contextual_reveal/_contextual_reveal_state.dart
...
class _ContextualRevealState extends State<ContextualReveal>
  ...
  void _onTap() {
    if (_popover.isVisible) {
      _fadeOut(_popover.remove);
      return;
    }
    _popover
      ..child = widget.child
      ..insertNonInteractive(context, onTap: () => _fadeOut(_popover.remove));

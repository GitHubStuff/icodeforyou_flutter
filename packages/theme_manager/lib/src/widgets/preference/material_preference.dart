...
import 'theme_selection_body.dart' show ThemeSelectionBody;
...
/// );
/// ```
class MaterialPreference extends StatelessWidget {
  /// Creates a [MaterialPreference] bound to the provided [cubit].
  ///

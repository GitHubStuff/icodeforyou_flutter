...
import 'package:theme_manager/src/theme_mode/shared_theme_persistence.dart'
...
void main() {
  group('ThemePersistence', () {
    ...
    test('create returns a ThemePersistence instance', () async {
      final persistence = await SharedThemePersistence.create();
      expect(persistence, isA<SharedThemePersistence>());
    });

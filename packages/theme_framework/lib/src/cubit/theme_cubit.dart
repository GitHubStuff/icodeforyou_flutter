// packages/theme_framework/lib/src/cubit/theme_cubit.dart
...
/// Abstact for Clean Arch to allow for testing
abstract interface class ThemeCubitInterface
    implements StateStreamableSource<ThemeMode> {
  /// Runs as the first startup task so the theme resolves behind the splash and
  /// the user never sees the repaint.
  Future<void> restore();

  /// Sets the theme mode {usually the new value is persited for app restart}
...
final class ThemeCubit extends Cubit<ThemeMode> implements ThemeCubitInterface {

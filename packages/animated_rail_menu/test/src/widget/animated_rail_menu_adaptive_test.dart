// animated_rail_menu/test/src/widget/animated_rail_menu_adaptive_test.dart
...
void main() {
  ...
  group('RailDirection.adaptive — phone portrait (390×844)', () {
    testWidgets('uses horizontal scaffold', (tester) async {
      ...
      await _pump(tester);
      expect(
        find.byKey(AnimatedRailMenu.horizontalScaffoldKey),
        findsOneWidget,
      );
    });
  ...
  group('RailDirection.adaptive — phone landscape (844×390)', () {
    testWidgets('uses vertical scaffold', (tester) async {
      ...
      await _pump(tester);
      expect(
        find.byKey(AnimatedRailMenu.verticalScaffoldKey),
        findsOneWidget,
      );
    });

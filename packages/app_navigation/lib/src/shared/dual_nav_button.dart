// packages/app_navigation/lib/src/shared/dual_nav_button.dart

import 'package:extensions/enum/src/haptic_intensity.dart' show HapticIntensity;
import 'package:flutter/material.dart';

/// The default fixed footprint of a [DualNavButton].
///
...
/// side of a screen.
///
/// A [DualNavButton] displays an [icon], a [caption], or both, stacked
...
/// invoking [onPressed].
class DualNavButton extends StatelessWidget {
  /// Creates a [DualNavButton].
  ///

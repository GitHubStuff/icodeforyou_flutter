// packages/app_navigation/lib/src/shared/dual_popover_tile.dart
...
class DualPopoverTile<T> extends StatelessWidget {
  /// Creates a [DualPopoverTile].
  const DualPopoverTile({
    required this.value,
    required this.label,
    super.key,
    this.icon,

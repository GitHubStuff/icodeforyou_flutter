// packages/app_navigation/lib/src/shared/dual_overflow_button.dart
...
/// A self-contained overflow button for a `Navigation Button widget`.
///
...
class DualOverflowButton<T> extends StatelessWidget {
  /// Creates a [DualOverflowButton].
  const DualOverflowButton({
  ...
  Future<void> _openPopover(BuildContext context) async {
    final result = await dualShowPopover<T>(

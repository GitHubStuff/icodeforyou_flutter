...
import 'package:service_locator/src/service_locator/service_locator.dart'
    show ServiceLocator;
import 'package:service_locator/src/service_locator_registry/service_locator_registry_interfaces.dart'
    show ServiceRegistrar, ServiceResolver;
import 'package:service_locator/src/service_locator_registry/service_registration.dart'
    show ServiceRegistration;

part 'service_locator_registry_state_change.dart';

// ───────────────────────────────────────────────────────────────────
// Concrete implementation
// ───────────────────────────────────────────────────────────────────

/// Concrete registry implementing both [ServiceRegistrar] and
/// [ServiceResolver].
///
/// Composition-root code constructs one with a backend [ServiceLocator]
/// (usually `GetItServiceLocator`) and hands narrower views — a
/// [ServiceRegistrar] for bootstrap code, a [ServiceResolver] for
...
class ServiceLocatorRegistry
    ...
    implements ServiceRegistrar, ServiceResolver {
  ...
  /// [SRV].
  ///
  /// Exposed on the concrete class (not on [ServiceRegistrar] or
  ...
  Future<void> _awaitNonStaged(
    ...
    switch (registration.status) {
      ...
      case LocatorStatus.staged:
        ...
        throw StateError(
          '_awaitNonStaged called on staged registration "${registration.name}"',
        );
      // coverage:ignore-end
    }
  }

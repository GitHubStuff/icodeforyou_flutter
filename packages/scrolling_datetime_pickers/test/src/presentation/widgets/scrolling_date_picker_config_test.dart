// packages/scrolling_datetime_pickers/test/src/presentation/widgets/scrolling_date_picker_config_test.dart
...
void main() {
  group('ScrollingDatePicker Configuration', () {
    ...
    testWidgets('should use portrait size in portrait orientation',
        (tester) async {
      const portraitSize = Size(220, 280);
      const landscapeSize = Size(320, 160);
    ...
    testWidgets('should use FadeConfiguration.light()', (tester) async {
      final lightFade = FadeConfiguration.light();
    ...
    testWidgets('should use FadeConfiguration.dark()', (tester) async {
      final darkFade = FadeConfiguration.dark();
    ...
    testWidgets('should use FadeConfiguration.forBackground()', (tester) async {
      final customFade = FadeConfiguration.forBackground(Colors.indigo);

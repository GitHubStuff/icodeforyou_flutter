// programs/template_app/lib/framework/application_startup.dart
  ...
  void run() {
    ...
    router = GoRouter(
      ...
      routes: [
        ...
        GoRoute(path: '/app', builder: (context, state) => home),
        GoRoute(path: '/error', builder: (context, state) => error),
      ],
    );

    runApp(ThemeApp(themeStore: themeStore, routerConfig: router));
  }
}

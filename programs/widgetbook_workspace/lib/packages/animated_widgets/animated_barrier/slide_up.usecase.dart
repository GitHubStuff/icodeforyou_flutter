// programs/widgetbook_workspace/lib/packages/animated_widgets/animated_barrier/slide_up.usecase.dart

import 'package:animated_widgets/animated_widgets.dart'
    show AnimatedBarrier, SlideFromBottomBarrier;
...
/// Dedicated demo for `SlideFromBottomBarrier` — the barrier enters by
/// sliding up from the bottom of the screen and exits the same way in
/// reverse. Knobs cover duration, curve, and barrier tint so the motion
/// can be tuned without leaving the usecase.
@widgetbook.UseCase(name: 'Slide up (from bottom)', type: AnimatedBarrier)
Widget slideUpAnimatedBarrierUseCase(BuildContext context) {
    ...
    body: Center(
      child: Builder(
        builder: (innerContext) => FilledButton(
          onPressed: () {
            AnimatedBarrier(
              barrierAnimation: SlideFromBottomBarrier(
          ...
          child: const Text('Slide up from bottom'),
        ),
      ),
    ),
  );

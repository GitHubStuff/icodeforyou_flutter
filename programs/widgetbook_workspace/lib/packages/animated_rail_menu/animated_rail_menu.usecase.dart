...
class _HorizontalHost extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => RailNavigationWidget(
...
@widgetbook.UseCase(name: 'Horizontal', type: RailNavigationWidget)
...
@widgetbook.UseCase(name: 'Vertical', type: RailNavigationWidget)
...
@widgetbook.UseCase(name: 'Overflow — More', type: RailNavigationWidget)
...
@widgetbook.UseCase(name: 'Haptic Feedback', type: RailNavigationWidget)
